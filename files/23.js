...
function FloatZoneAD_Show() {
  ...
  document.write("<div id='" + this.DivName + "' onMouseOver='" + this.ID+".Pause()' onMouseOut='" + this.ID+".Resume()' style='position:absolute; z-index:101; width:" + this.ZoneWidth + "px; height:" + this.ZoneHeight + "px; left:" + this.Left + "px;top:" + this.Top + "px'>" + AD_Content(this.ShowAD) + "");
  if(this.ShowCloseAD){
...
function AD_Content(o) {
  ...
  return str;
}var ZoneAD_23=new FloatZoneAD("ZoneAD_23");ZoneAD_23.ZoneID=23;ZoneAD_23.ZoneWidth=302;ZoneAD_23.ZoneHeight=126;ZoneAD_23.ShowType=1;ZoneAD_23.FloatType= 2;ZoneAD_23.Left= 100;ZoneAD_23.Top= 150;ZoneAD_23.ShowCloseAD=true;ZoneAD_23.CloseFontColor="#9dcb1d";ZoneAD_23.LocalityType = 1;ZoneAD_23.Show();